 ...
 */
define(["dao", "db", "globals", "ui", "core/champion", "data/championPatch", "data/agents", "core/draft", "core/finances", "core/phase", "core/player", "core/team", "lib/bluebird", "lib/jquery", "lib/underscore", "util/helpers", "util/random"], function (dao, db, g, ui,champion,championPatch,agent, draft, finances, phase, player, team, Promise, $, _, helpers, random) {
    "use strict";
    ...
    function create(name, tid,typeid,patchid, leagueFile, startingSeason, randomizeRosters) {
	    ...
	    if (typeid == 0) {
			...
			conferences = [{cid: 0, name: "Champions Tour: Americas League"}];
       ...
       // Any custom teams?
        ...
        //    championLength = merge(leagueFile.champions, cDefault);
          ...
          //  teams = helpers.addPopRank(teams);
			...
			championLength = agent.agents.length;
            //teams = teamsDefault;
        }
...
//                numChampions: agent.agents.length, // Will be 30 if the user doesn't supply custom rosters
...
//                    pots = [75, 65, 55, 55, 60, 50, 70, 40, 55, 50, 60, 60, 45, 45];
                    baseRatings = [27, 37, 36, 35, 34, 33, 32, 31];
                    pots = [55, 65, 55, 55, 60, 50, 50, 40];
...
//							adjustment = -50;
                        ...
                        for (n = 0; n < 8; n++) {
							...
							if ( (g.userTid == t) && (n<5) ) {
							    userPlayerPos = "";
								timeThrough = 0;
							    while ( (((userPlayerPos != "Duelist") && (n == 0))  || ((userPlayerPos != "Initiator") && (n == 1)) || ((userPlayerPos != "Sentinal") && (n == 2)) || ((userPlayerPos != "Smokes") && (n == 3)) || ((userPlayerPos != "Sup") && (n == 4)) ) && (timeThrough<20) ) {
                            ...
                            player.updateValues(tx, p, []).then(function (p) {
                                ...
                                if (p.tid === g.PLAYER.FREE_AGENT) {
                                    ...
                                    //Gets a player then puts a player on a team
